...
@property (nonatomic, strong) IBOutlet UIButton * _Null_unspecified btn1People;
@property (nonatomic, strong) IBOutlet UIButton * _Null_unspecified btn2People;
@property (nonatomic, strong) IBOutlet UIButton * _Null_unspecified btn3People;
...
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (IBAction)btnPeopleSelection:(UIButton * _Nonnull)sender;
...
@property (nonatomic, strong) IBOutlet UIScrollView * _Null_unspecified scrolView;
